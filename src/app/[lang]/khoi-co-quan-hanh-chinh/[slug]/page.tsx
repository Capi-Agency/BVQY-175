...
async function getLangSlugDetail(): Promise<string> {
    ...
    return lang === 'en' ? 'chi-tiet-khoi-co-quan-hanh-chinh-en' : 'chi-tiet-khoi-co-quan-hanh-chinh';
}
...
export async function generateMetadata(
    ...
    const lang = await getLang();
    const data = await fnGetDepartmentDetail({ collection: 'administration_departments', slug });
    if (!data) notFound();
