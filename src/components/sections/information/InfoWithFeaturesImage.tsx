...
export default function InfoWithFeaturesImage({ data }: CommonSection) {
  return (
    <section className="container flex flex-col gap-20 py-10 md:gap-40 md:py-12 lg:py-20 xl:flex-row xl:gap-6 2xl:py-24 2xl:gap-7 3xl:py-[140px] 4xl:justify-between">
