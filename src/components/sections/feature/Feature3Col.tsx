...
export default function Feature3Col({ data }: CommonSection) {
  ...
  return (
    <section className="bg-white py-10 md:py-6 lg:py-10 xl:py-[52px] 2xl:py-[64px] 3xl:py-[72px] 4xl:py-[80px]">
      <div className="grid-cols-1 gap-6 md:container md:grid md:grid-cols-3 md:gap-4 xl:gap-4 2xl:gap-6 3xl:gap-8">
        <div className="px-6 md:col-span-2 md:px-0 lg:col-span-1">
          ...
          <div
            className="mt-2 text-sm font-normal text-[#3F3F46] lg:mt-4 2xl:text-base 3xl:mt-6"
                ...
                >
                  <div className="space-y-3 xl:space-y-4">
                    <div className="relative aspect-video w-full overflow-hidden">
                      <NextImg
                        src={getAssetUrlById(
                          item?.thumbnail?.id || item?.thumbnail,
                        )}
                        alt="Chuyên khoa image"
                        objectFit="cover"
                      />
