      ...
      <div className="container grid grid-cols-4 gap-10">
        ...
        {data?.items?.map((item: any, index: number) => (
          <Link
            ...
            className="bg-primary-50 group block space-y-4 p-4 transition-all duration-200 hover:bg-secondary hover:shadow-[0_25px_45px_-12px_rgba(18,26,43,0.20)]"
          >
            ...
            <div className="space-y-1">
              <div className="group-hover:text-primary-50 line-clamp-2 h-[72px] text-2xl font-semibold text-[#010502] transition-all duration-200">
                {item?.title}
              </div>
              <div
            ...
            <div className="flex items-center gap-2">
              <div className="group-hover:text-primary-50 text-lg font-medium text-[#09090B] transition-all duration-200">
                {data?.buttons?.[1]?.title}
              </div>

              <div className="relative size-6 transition-all duration-200 group-hover:invert">
                <NextImg
