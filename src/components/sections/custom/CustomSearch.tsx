...
export default function CustomSearch({ data }: CommonSection) {
  ...
  return (
    <section className="py-8 lg:container lg:py-12 xl:py-[60px] 2xl:py-[80px] 3xl:py-[100px] 4xl:py-[120px]">
      <div className="relative flex flex-col gap-5 lg:grid lg:grid-cols-[auto,220px] lg:gap-6 xl:gap-7 2xl:grid-cols-[auto,240px] 2xl:gap-8 3xl:grid-cols-[auto,260px] 3xl:gap-10">
